...
<body>
    ...
    <div id="box">
        ...
        <div id="right">
            <form method="post" action="save_jieyue.php">
                <table>
                    <tr>
                        <td>借阅人:</td>
                        <td><input name="jieyueren" type="text"/></td>
                    </tr>
                    <tr>
                        <td>借阅日期:</td>
                        <td><input name="jieyueriqi" type="text"/></td>
                    </tr>
                    <tr>
                        <td>图书名:</td>
