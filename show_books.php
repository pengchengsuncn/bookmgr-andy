    ...
    <div id="box">
        <div id="left">
            <ul>
                ...
                <li><a href="tushuleixing.php">查看图书分类</a></li>
        ...
        <div id="right">
        	<?php
				...
				//拼写SQL语句
				$sQuery = "SELECT * FROM tushubiao";
				//执行SQL语句
				$bookList = mysql_query($sQuery);				
			?>
            <br />
            <table border="1" align="center">
                ...
                <?php
					//循环显示查询到的每一本书
					while($row = mysql_fetch_array($bookList)){
					   echo "<tr>";
					   echo "<td>".$row['tushuming']."</td>";
					   echo "<td>".$row['zuozhe']."</td>";
					   echo "<td>".$row['chubanshe']."</td>";
					   echo "<td>".$row['jiage']."</td>";
					   echo "<td><a href='edit_book.php?bookId=".$row['ID']."'>修改</a>|<a href='delete_book.php?bookId=".$row['ID']."'>删除</a></td>";
					   echo "</tr>";
					}
					//从内存中释放查到的结果集
					mysql_free_result($bookList);
					//关闭SQL连接
					mysql_close();
				?>
            </table>
