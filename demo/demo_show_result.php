...
<div id="container">
		...
		<div id="lesson">
			...
			<div id="auto_banner">
				<ul>
					...
					<li><img src='images/banner/Tomb-sweeping.jpg' alt='清明时节雨纷纷！' width='688' height='163'></li>
	...
	<?php
		$sQuery = "select kw_image_id,kw_image_path,kw_image_width,kw_image_height from kwtbl_images";
			...
			<ul>
				<?php
					while($row = mysql_fetch_array($photoList)){
					   echo "<li><img src='".$row['kw_image_path']."' alt='".$row['kw_image_id']."' width='".$row['kw_image_width']."' height='".$row['kw_image_height']."'></li>";
					}
